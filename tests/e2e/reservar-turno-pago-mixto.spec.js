...
test('Facundo reserva el turno que se utilizara para probar el pago mixto', async ({ page }) => {
    ...
    await page.locator('form#form input[type="email"]').fill('facuperez0703@gmail.com');
    await page.locator('form#form input[type="password"]').fill('12345678');
