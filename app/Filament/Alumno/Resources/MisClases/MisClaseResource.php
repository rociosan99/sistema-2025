...
namespace App\Filament\Alumno\Resources\MisClases;

use App\Filament\Alumno\Resources\MisClases\Pages\ListMisClases;
use App\Filament\Alumno\Resources\MisClases\Pages\ViewMisClase;
use App\Filament\Alumno\Resources\MisClases\Tables\MisClasesTable;
                ...
                Section::make('Clase')
                    ...
                    ->schema([
                        ...
                        TextEntry::make('profesor')
                            ->label('Profesor')
                            ->state(fn (Turno $record): string => static::nombreCompleto($record->profesor)),
